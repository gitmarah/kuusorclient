...
const Home: React.FC = () => {
    ...
    return (
        <>
            <Header />
            <div className='md:max-w-3/4 md:mx-auto pt-17 px-5 md:px-0'>
            ...
            <main className='px-5 md:px-0 md:max-w-3/4 lg:max-w-full lg:px-10 md:mx-auto'>
                {fetchingCompanyInternships ? <div className='flex justify-center items-center pt-3'><Loader color='pri' bgcolor='transparent' /></div> : <div><div className='grid md:grid-cols-2 lg:grid-cols-3 gap-2 pb-3 text-bblack'>
                ...
                {fetchingInternships ? <div className='flex justify-center items-center pt-3'><Loader color='pri' bgcolor='transparent' /></div> : user?.role === "STUDENT" && <div><div className='grid md:grid-cols-2 lg:grid-cols-3 gap-2 text-bblack py-3'>

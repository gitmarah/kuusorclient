        ...
        <>
            <Header />
                <main className='pt-16 px-4  md:px-0 md:max-w-3/4 md:mx-auto'>
                    {(!isLoadingApplications && applications.length > 0) && <h2 className='font-original text-center text-pri px-4 mb-2 text-sm'>Pending Applications</h2>}
                ...
                {(!isLoadingApplications && applications.length === 0) && <div className='w-full fixed top-0 bottom-0 left-0 right-0 flex flex-col justify-center items-center'>
